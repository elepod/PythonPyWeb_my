...
class AuthorViewSetTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.author1 = Author.objects.create(name='John_test', email='john_test@example.com')
        self.author2 = Author.objects.create(name='Alice_test', email='alice_test@example.com')
    ...
    def test_list_authors(self):
        ...
        response = self.client.get(url, {'page_size': 1000})  # Отправляем запрос получить много элементов в пагинации
